...
png("proteins5_pub/QfeatNormAll.png", units = "px", width = 1200, height = 800)
par(mfrow = c(1, 3))
...
write.table(combined_results, "proteins5_pub/AnalyzedResults.tsv",
...
#save
ggsave("proteins5_pub/CombinedBayeseanBHcorrectedWTexpressionVSL2F.png", width = 13, height = 18)
